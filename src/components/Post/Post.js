    ...
    <>
      {post.comments ? (
        <motion.div
          ...
          ref={pageTopRef}>
          <Sidebar root={root} />
          <CommentContainer container direction='column' alignItems='center'>
            {newClicked === true ? (
              <>
                <MaskDiv onClick={newClickHandler} />
                {scrollToTop()}
                <NewComment style={{ zIndex: 999 }} post={post} />
              </>
            ) : null}
            {editClicked === true ? (
              <>
                <MaskDiv onClick={editClickHandler} />
                {scrollToTop()}
                <EditPost style={{ zIndex: 999 }} post={post} />
              </>
            ) : null}
            <PostCard>
            ...
            {user.id ? (
              <>
                <SideBar container item xs={4}>
                  <NewCommentStyle onClick={newClickHandler}>
                    <AddCircleIcon />
                    New
                  </NewCommentStyle>
                  <NewCommentStyle component={Link} to={`/${root}/chat`}>
                    <ChatIcon />
                    Chat
                  </NewCommentStyle>
                </SideBar>
