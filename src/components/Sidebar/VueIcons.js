  ...
  return (
    <>
      <motion.div
        ...
        >
          <IconLink to='/reactjs'>
            <Icon to='/reactjs' className='extra'>
              <motion.img
          ...
          <IconLink to='/javascript'>
            <Icon to='/javascript' className='extra'>
              <motion.img
                whileHover={{ scale: 1.1 }}
                transition={transition}
                initial='out'
          ...
          <IconLink to='/angular'>
            <Icon to='/angular' className='extra'>
              <motion.img
                whileHover={{ scale: 1.1 }}
                transition={transition}
                initial='out'
