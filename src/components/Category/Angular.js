...
function Angular({imageSize, fetchPosts, posts, root, topic, user}) {
    useEffect(() => {
        fetchPosts()
    }, [])
        ...
        exit='exit'>
                ...
                <div>
                    <IconGrid
                        ...
                        alignItems="baseline">
                    <IconLink to="/reactjs"><Icon className="extra"><motion.img transition={transition} initial={{opacity: 1}} animate={{opacity: 0.1}} alt="ReactJS" src="https://i.ibb.co/HqZ0RMF/ezgif-5-5320ccde36a0.webp" /></Icon></IconLink>
                    ...
                    <Icon>
                    <MotionImage
                        src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Angular_full_color_logo.svg/200px-Angular_full_color_logo.svg.png"
                        alt='AngularJS'
