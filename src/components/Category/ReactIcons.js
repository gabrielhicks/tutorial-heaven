        ...
        <>
            ...
            exit='exit'> */}
                ...
                <div>
                    ...
                    {/* <IconLink to="/reactjs"><Icon className="extra"><motion.img transition={transition} initial="out" animate="in" exit="out" variants={pageTransition} alt="React" src="https://i.ibb.co/HqZ0RMF/ezgif-5-5320ccde36a0.webp" /></Icon></IconLink> */}
                    <IconLink to="/rails"><Icon className="extra"><motion.img transition={transition} initial="out" animate="out" exit="in" variants={pageTransition} alt="Ruby on Rails" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Ruby_logo.svg/200px-Ruby_logo.svg.png" /></Icon></IconLink>
